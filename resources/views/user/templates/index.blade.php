...
<main class="grow relative z-10 flex flex-col bg-[#FAFAFA] dark:bg-slate-900 pt-28 pb-20">
    <div class="max-w-7xl w-full mx-auto px-6 flex flex-col gap-8">
        @if(session('success'))
        <div id="toast-success" class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800 rounded-xl">
        ...
        @if(session('error'))
        <div id="toast-error" class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-xl">
