...
<head>
    ...
    <title>Masuk - BikinWebsite</title>
    ...
    <div class="relative z-10 w-full max-w-md px-6">
        ...
        <div class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-[2rem] p-8 shadow-2xl border border-white/20 dark:border-slate-700/50">
            ...
            <div class="mt-6 flex items-center justify-center space-x-2">
                ...
                <span class="text-xs text-slate-400 font-medium px-2">ATAU</span>
                <div class="h-px w-full bg-slate-200 dark:bg-slate-700"></div>
            </div>

            <div class="mt-6 grid grid-cols-3 gap-3">
                <a href="{{ route('socialite.redirect', 'google') }}" class="flex items-center justify-center py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors shadow-sm" title="Masuk dengan Google">
                    <img src="https://www.svgrepo.com/show/475656/google-color.svg" alt="Google" class="w-5 h-5">
                </a>
                <a href="{{ route('socialite.redirect', 'facebook') }}" class="flex items-center justify-center py-2.5 bg-[#1877F2]/10 dark:bg-[#1877F2]/20 border border-[#1877F2]/20 dark:border-[#1877F2]/30 rounded-xl hover:bg-[#1877F2]/20 dark:hover:bg-[#1877F2]/30 transition-colors shadow-sm" title="Masuk dengan Facebook">
                ...
                <a href="{{ route('socialite.redirect', 'instagram') }}" class="flex items-center justify-center py-2.5 bg-pink-500/10 dark:bg-pink-500/20 border border-pink-500/20 dark:border-pink-500/30 rounded-xl hover:bg-pink-500/20 dark:hover:bg-pink-500/30 transition-colors shadow-sm" title="Masuk dengan Instagram">
